...
const defaultForm = {
  title: '', // 标题
  cate_id: '1', // 分类id
  cover_img: 'https://cdn.luogu.com.cn/upload/image_hosting/82kdgdot.png', // 封面图片 file 对象
  content: '', // string 内容
  state: '发布' // 状态
}
...
const open = async (row) => {
  ...
  console.log(row);
  const res1 = await artGetDetailService();
  console.log(res1.data.data.content);
  if (row.id) {
...
<template>
  ...
  >
    ...
    <el-form :model="formModel" ref="formRef" label-width="100px">
      <el-form-item label="你的名字" prop="title">
        <el-input v-model="formModel.title" placeholder="请输入你的名字"></el-input>
      </el-form-item>
<!--      <el-form-item label="文章封面" prop="cover_img">-->
<!--        &lt;!&ndash; 此处需要关闭 element-plus 的自动上传，不需要配置 action 等参数-->
...
<!--      </el-form-item>-->
      ...
      <el-form-item>
        <el-button @click="onPublish('发布')" type="primary">发布</el-button>
